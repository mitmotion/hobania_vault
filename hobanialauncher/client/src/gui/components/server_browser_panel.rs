...
use tracing::debug;
use url::Url;
use hobania_serverbrowser_api::{FieldContent, GameServer};
                ...
                status_icons = status_icons.push(
                    tooltip(
                        image(Handle::from_memory(STAR_ICON.to_vec()))
                            .height(Length::Units(16))
                            .width(Length::Units(16)),
                        "This is an official server operated by the Hobania project",
                        Position::Right,
                    )
                    .gap(5)
                    .style(TooltipStyle),
            ...
            let row = row()
                ...
                .push(
                    column_cell(
                        ...
                        // name to a length which doesn't wrap when the Hobanialauncher window
