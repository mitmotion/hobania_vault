...
pub enum ClientError {
    ...
    IcedError,
    #[display(fmt = "FATAL: Failed to save/load hobanialauncher configuration!")]
    RonError,
    #[display(fmt = "Failed to parse Hobania News.")]
    RssError,
    #[display(fmt = "Failed to open webbrowser.")]
    OpenerError,
    #[display(fmt = "Error with downloaded hobania archive.")]
    ArchiveError,
    ...
    #[cfg(windows)]
    #[display(fmt = "FATAL: Failed to update hobania_launcherr!")]
    UpdateError,
    #[cfg(windows)]
...
pub fn panic_hook() {
    ...
    panic::set_hook(Box::new(move |panic_info| {
        ...
        tracing::error!("hobanialauncher panicked: \n\n{}: {}", reason, panic_info,);
