...
// TODO: Is there a way to figure out whether hobanialauncher has been installed or not
//       to allow to use another base location and avoid polluting the current install
// while developing?

/// Returns the base path where all hobanialauncher files like config, profiles belong.
///
/// |Platform | Example                                                       |
/// | ------- | ------------------------------------------------------------- |
